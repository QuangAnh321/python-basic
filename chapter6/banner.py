def banner_text(text: str = " ", screen_width: int = 80) -> None:
    """
    Print a `text` with a specified `screen_width`
    :param text: The text to print, default is " "
    :param screen_width: The width of the text on screen, default is 80
    :raise ValueError if the supplied text is too long to fit
    """
